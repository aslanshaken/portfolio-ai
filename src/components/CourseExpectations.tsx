    ...
    <Box sx={{ flexGrow: 1,backgroundImage: `url(${CourseBg})`, padding: "50px  50px 0px 50px", borderRadius: "10px" }}>
      <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }} sx={gridsection}>
          <Grid item xs={12} md={6}>
            ...
            <Box component="p">У каждого ученика будет личный кабинет, где он сможет просматривать уроки и сдавать экзамен.</Box>
            </Stack>
            </Box>
            <Box>
            ...
            <Box component="p">Курс составлен на 85% практики, что предполагает интенсивные практические занятия с двумя реальными компаниями. На уроках вас ждут презентации, таблицы, тесты, готовые шаблоны, домашние задания и бонусные видео-уроки.
</Box>
            </Stack>
            </Box>
            <Box>
          ...
          <Grid item xs={12} md={6}>
            ...
            <Box component="p">На практических уроках уроки будут до 15 минут по каждой операции отдельно, чтобы быстрее и легче усваивалась информация.</Box>
            </Stack>
            </Box>
            <Box>
            ...
            <Box component="p">Закрытое сообщество в телеграм канале и на Facebook будет доступно каждому ученику.</Box>
            </Stack>
            </Box>
            <Box>
      ...
      <Box sx={{pt:4,pb:"3px"}}><Typography sx={{color:"#fff", textAlign:"center"}}>*Доступно на тарифе Стандарт</Typography></Box>
    </Box>
    </Container>
  );
}