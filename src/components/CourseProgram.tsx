...
export default function CustomizedAccordions() {
        ...
        <List>
          ...
          <ListItem>
            <List>
              ...
              <ListItem sx={{color: 'gray'}}>- Ledger, Chart of Accounts and Trial Balance - Главная книга, план счетов и пробный баланс</ListItem>
              <ListItem sx={{color: 'gray'}}>- Демонстрация Ledger, Chart of Accounts and Trial Balance - Бухгалтерской книги, план счетов и пробного баланса</ListItem>
    ...
    },
    {
      ...
      content: (
        <List>
           <ListItem>
            <List>
              <ListItem sx={{fontWeight:'600', fontSize:'larger'}}>1. Ознакомление с платформой Quickbooks online и с клиентом</ListItem>
              ...
              <ListItem sx={{color: 'gray'}}>- Review Trial balance & Close Periods - Проверить пробный баланс и закрыть период</ListItem>
              <ListItem sx={{color: 'gray'}}>- Checklist & Wrapup - Контрольный список и подведение итогов</ListItem>
            </List>
          </ListItem>
          <ListItem>
            <List>
              <ListItem sx={{fontWeight:'600', fontSize:'larger'}}>2. Денежные поступления и дебиторская задолженность</ListItem>
              <ListItem sx={{color: 'gray'}}>- Введение</ListItem>
          ...
          <ListItem>
            <List>
              <ListItem sx={{fontWeight:'600', fontSize:'larger'}}>3. Денежные выплаты и кредиторская задолженность</ListItem>
              <ListItem sx={{color: 'gray'}}>- Введение</ListItem>
              <ListItem sx={{color: 'gray'}}>- Обзор Accounts Payable and Expenses - кредиторская задолжность и расходов</ListItem>
              <ListItem sx={{color: 'gray'}}>- Создание Vendors - поставщиков</ListItem>
              <ListItem sx={{color: 'gray'}}>- Создание Bills - счетов</ListItem>
              <ListItem sx={{color: 'gray'}}>- Создание Expenses and Billable Expenses - Расходы и Оплачиваемые Расходы</ListItem>
              <ListItem sx={{color: 'gray'}}>- Создание Сhecks and Bill Payment - Чеки и Оплаты счетов</ListItem>
              <ListItem sx={{color: 'gray'}}>- Создание Vendor Credit and Invoice for Unbilled Expenses - Кредит Поставщика и Счет за неоплаченные расходы</ListItem>
              <ListItem sx={{color: 'gray'}}>- Overview Lesson - Обзорный урок/проверка отчетов</ListItem>
            </List>
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            <List>
              ...
              <ListItem sx={{color: 'gray'}}>- Создание Note Payments - оплаты по задолжностям по кредитам банка</ListItem>
              <ListItem sx={{color: 'gray'}}>- Создание Adjusting Entries and Overview Lesson- Корректирующие записи и Обзорный урок/проверка отчетов</ListItem>
            </List>
          </ListItem>
          <ListItem>
            <List>
              ...
              <ListItem sx={{color: 'gray'}}>- Обьяснения что такое Payroll Liability - обязательство по заработной плате</ListItem>
              ...
              <ListItem sx={{color: 'gray'}}>- Запись Sales Tax and Overview Lesson - Налог с продаж и Обзорный урок/проверка отчетов</ListItem>
            </List>
          </ListItem>
          <ListItem>
            <List>
          ...
          <ListItem>
            <List>
              ...
              <ListItem sx={{color: 'gray'}}>- Owner Distribution PART 2 and Overview Lesson - Выведение денег Владельца и Обзорный урок/проверка отчетов</ListItem>
            </List>
          </ListItem>
          <ListItem>
            <List>
              ...
              <ListItem sx={{color: 'gray'}}>- Uploading & Working with Bank Feed - Загрузка и работа с банковским отделом</ListItem>
        ...
        <>
          ...
          <Box>
            ...
            <ListItem>
              ...
              WebkitTextFillColor: 'transparent', fontSize: "30px !important", fontWeight: "600"
                ...
                <ListItem sx={{color: 'gray'}}>- Собственный капитал, заработная плата и корректирующие проводки</ListItem>
  ...
  return (
    <Box sx={{ pt: 2 }}>
      <Container>
        <Typography variant="h2" mb={6}><Box component="span" className="TextGradientPrimary">Программа</Box> курса</Typography>
            ...
            {accordionData.map((item) => (
              <Accordion key={item.id} expanded={expanded === item.id} onChange={handleChange(item.id)}>
                <AccordionSummary aria-controls={`${item.id}-content`} id={`${item.id}-header`}>
                  <Typography sx={{ display: "flex", alignItems: "center" }}>ЧАСТЬ<Box component="span" color="#41635C" sx={{ px: 1, fontSize: { xs: "28px", lg: "36px", xl: "40px", xxl: "48px" } }}>{item.id}</Box></Typography>
                </AccordionSummary>
                <AccordionDetails>
